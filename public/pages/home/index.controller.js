...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // cardContainer.innerHTML += card("MADRID", "Descubre madrid"," 1.250.000","1", "");
    // cardContainer.innerHTML += card("BARCELONA", "Conoce barcelona","1.000.000","1", "");
    // cardContainer.innerHTML += card("VALENCIA", "Descubre Valencia","3000","1", "");
